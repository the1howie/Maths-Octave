...
clear; close all;
% INPUT the lengths of the adjacent sides to the 90 degrees angle:
a = 4; b = 3; % a = 4; b = 3; % a = 12; b = 5; % a = 15; b = 8; % a=1; b=1;
c = sqrt(a^2 + b^2); % hypothenuse
...
grid on; title("Pythagorean Theorem: a^2 + b^2 = c^2");
...
grid on; title("Build (a+b)-by-(a+b) perfect square, area: (a+b)^2 = 2ab + c^2");
...
quiver(p1(1),p1(2),dp(1),dp(2),0,'MaxHeadSize',0.2,'color',[1,0,0],'LineWidth',1.5);
hold off; axis equal;
grid on; title("Re-arranged (a+b)-by-(a+b) perfect square, area: (a+b)^2 unchanged");
...
title("Proof that a^2 + b^2 = c^2 since area (a+b)^2 = 2ab + c^2 = a^2 + 2ab + b^2");
% End of proof.
